...
const CustomNode: React.FC<CustomNodeProps> = ({ id, data }) => {
  ...
  return (
    <div className="relative p-4 rounded-xl bg-white dark:bg-gray-800 shadow-xl min-w-[200px] max-w-[300px]
      ...
      <div className="relative">
        <div className="flex justify-between items-center mb-2">
          <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Node</span>
          <button
